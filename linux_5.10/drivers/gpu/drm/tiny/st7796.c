 ...
 * Copyright 2026 Cryolitia PukNgae
 *
...
static int st7796_probe(struct spi_device *spi) {
  ...
  int ret;
	struct mipi_dbi_dev *dbidev =
      devm_drm_dev_alloc(dev, &st7796_driver, struct mipi_dbi_dev, drm);
...
MODULE_AUTHOR("Cryolitia PukNgae <t.artsamart@gmail.com>");
MODULE_LICENSE("GPL");
